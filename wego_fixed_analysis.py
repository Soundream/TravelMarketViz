...
def create_monthly_visualizations(app_data, web_data):
    ...
    if app_data is not None:
        ...
        plt.tight_layout()
        plt.savefig('wego_monthly_app_downloads_fixed.png', dpi=300)
        print("\nMonthly app downloads visualization saved as 'wego_monthly_app_downloads_fixed.png'")
        ...
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig('wego_monthly_app_market_share_fixed.png', dpi=300)
        print("Monthly app download market share visualization saved as 'wego_monthly_app_market_share_fixed.png'")
    ...
    if web_data is not None:
        ...
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig('wego_monthly_web_visits_fixed.png', dpi=300)
        print("Monthly web visits visualization saved as 'wego_monthly_web_visits_fixed.png'")
        ...
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig('wego_monthly_web_market_share_fixed.png', dpi=300)
        print("Monthly web visit market share visualization saved as 'wego_monthly_web_market_share_fixed.png'")
...
if monthly_app_analysis is not None:
    monthly_app_analysis.to_csv('wego_monthly_app_downloads_fixed.csv', index=False)
    print("\nMonthly app downloads analysis saved to 'wego_monthly_app_downloads_fixed.csv'")
    
if monthly_web_analysis is not None:
    monthly_web_analysis.to_csv('wego_monthly_web_visits_fixed.csv', index=False)
    print("Monthly web visits analysis saved to 'wego_monthly_web_visits_fixed.csv'")
